...
| [brookhong/KeyCastOW](https://github.com/brookhong/KeyCastOW) | keystroke visualizer for Windows, lets you easily display your keystrokes whi... |
...
| [Cateners/tiny_computer](https://github.com/Cateners/tiny_computer) | Click-to-run debian 13 with desktop environment on android for Chinese users,... |
...
| [Chzxxuanzheng/Stapxs-QQ-Lite-X](https://github.com/Chzxxuanzheng/Stapxs-QQ-Lite-X) | 一个跨协议的 Stapxs QQ Lite 发行版。 |
...
| [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) | 🌩 Self-hosted file management and sharing system, supports multiple storage p... |
...
| [fastapi/fastapi](https://github.com/fastapi/fastapi) | FastAPI framework, high performance, easy to learn, fast to code, ready for p... |
| [fastfetch-cli/fastfetch](https://github.com/fastfetch-cli/fastfetch) | A maintained, feature-rich and performance oriented, neofetch like system inf... |
| [fastogt/fastonosql](https://github.com/fastogt/fastonosql) | FastoNoSQL is a crossplatform Redis, Memcached, SSDB, LevelDB, RocksDB, UnQLi... |
| [fatedier/frp](https://github.com/fatedier/frp) | A fast reverse proxy to help you expose a local server behind a NAT or firewa... |
| [FBlackBox/BlackBox](https://github.com/FBlackBox/BlackBox) | BlackBox is a virtual engine, it can clone and run virtual application on And... |
| [fcitx/fcitx5-rime](https://github.com/fcitx/fcitx5-rime) | None |
| [fcitx5-android/fcitx5-android](https://github.com/fcitx5-android/fcitx5-android) | Fcitx5 input method framework and engines ported to Android |
| [fcitx5-android/fcitx5-android-updater](https://github.com/fcitx5-android/fcitx5-android-updater) | None |
...
| [glincker/thesvg](https://github.com/glincker/thesvg) | 5,600+ brand SVG icons for developers. Tree-shakeable, typed, open source. np... |
...
| [go-gitea/gitea](https://github.com/go-gitea/gitea) | Git with a cup of tea! Painless self-hosted all-in-one software development s... |
...
| [HKUDS/CLI-Anything](https://github.com/HKUDS/CLI-Anything) | CLI-Anything: Making ALL Software Agent-Native -- CLI-Hub: https://clianythin... |
...
| [HMCL-dev/HMCL-Update](https://github.com/HMCL-dev/HMCL-Update) | None |
| [hmjz100/123panYouthMember](https://github.com/hmjz100/123panYouthMember) | 123 云盘会员青春版 - 模拟 123 云盘会员，还支持隐藏广告、使用视频倍速、修改头像、修改用户名、修改等级等功能；123云盘辅助增强脚本 - “解锁... |
| [hmjz100/LinkSwift](https://github.com/hmjz100/LinkSwift) | 一个基于 JavaScript 的网盘文件下载地址获取工具。基于【网盘直链下载助手】修改 ，支持 百度网盘 / 阿里云盘 / 中国移动云盘 / 天翼云盘 ... |
...
| [IdreesInc/Miracode](https://github.com/IdreesInc/Miracode) | A sharp, readable, vector-y version of Monocraft, the programming font based ... |
...
| [jumpserver/jumpserver](https://github.com/jumpserver/jumpserver) | JumpServer is an open-source Privileged Access Management (PAM) platform that... |
...
| [LeanxModulostk/wifi-bonding-nolog](https://github.com/LeanxModulostk/wifi-bonding-nolog) | This module doubles your bandwidth, disables Wi-Fi packet logging (has high o... |
...
| [LetTTGACO/elog](https://github.com/LetTTGACO/elog) | Markdown 批量导出工具、开放式跨平台博客解决方案，随意组合写作平台(语雀/Notion/FlowUs/飞书/我来Wolai)和博客平台(Hexo/... |
...
| [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) | An unprofessional open-source Chinese font derived from Fontworks' Klee One. ... |
...
| [lz233/OneText_For_Android](https://github.com/lz233/OneText_For_Android) | A neat little application that can display some custom sentences through widg... |
...
| [marchaesen/vcxsrv](https://github.com/marchaesen/vcxsrv) | Windows X-server based on the xorg git sources (like xming or cygwin's xwin),... |
...
| [marie-systems/win7-sp2](https://github.com/marie-systems/win7-sp2) | UNOFFICIAL Windows 7 Service Pack 2, to improve basic Windows 7 usability on ... |
...
| [MCreator/MCreator](https://github.com/MCreator/MCreator) | MCreator is an open-source software used to make Minecraft Java Edition mods,... |
...
| [MetaCubeX/mihomo](https://github.com/MetaCubeX/mihomo) | A simple Python Pydantic model for Honkai: Star Rail parsed data from the Mih... |
...
| [microsoft/JARVIS](https://github.com/microsoft/JARVIS) | JARVIS, a system to connect LLMs with ML community. Paper: https://arxiv.org/... |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | Python tool for converting files and office documents to Markdown. |
| [microsoft/sudo](https://github.com/microsoft/sudo) | It's sudo, for Windows |
| [microsoft/terminal](https://github.com/microsoft/terminal) | The new Windows Terminal and the original Windows console host, all in the sa... |
...
| [mulaRahul/keyviz](https://github.com/mulaRahul/keyviz) | Keyviz is a free and open-source tool to visualize your keystrokes ⌨️ and 🖱️ ... |
...
| [nining377/dolby_beta](https://github.com/nining377/dolby_beta) | 杜比大喇叭的β版迎来了重大的革新，合并了UnblockMusic Pro的所有功能且更加强大，同时UnblockMusicPro_Xposed项目将会停止... |
...
| [nufeng1999/WSL_GNOME](https://github.com/nufeng1999/WSL_GNOME) | Environment configuration for WSL running Gnome |
| [Nuitka/Nuitka](https://github.com/Nuitka/Nuitka) | Nuitka is a Python compiler written in Python.  It's fully compatible with Py... |
...
| [NvChad/NvChad](https://github.com/NvChad/NvChad) | Blazing fast Neovim framework providing solid defaults and a beautiful UI, en... |
...
| [okxlin/appstore](https://github.com/okxlin/appstore) | 1Panel 应用商店的非官方应用适配库  1Panel Store Unofficial App Adaptation Repository (http... |
...
| [PrismLauncher/PrismLauncher](https://github.com/PrismLauncher/PrismLauncher) | A custom launcher for Minecraft that allows you to easily manage multiple ins... |
...
| [PurpurMC/Purpur](https://github.com/PurpurMC/Purpur) | Purpur is a drop-in replacement for Paper servers designed for configurabilit... |
...
| [pzcn/Perfect-Icons-APP](https://github.com/pzcn/Perfect-Icons-APP) | None |
...
| [rayenghanmi/RyTuneX](https://github.com/rayenghanmi/RyTuneX) | RyTuneX is a cutting-edge optimizer built with the WinUI 3 framework, designe... |
...
| [rizonesoft/Notepad3](https://github.com/rizonesoft/Notepad3) | Notepad like text editor based on the Scintilla source code. Notepad3 based o... |
...
| [RVC-Boss/GPT-SoVITS](https://github.com/RVC-Boss/GPT-SoVITS) | 1 min voice data can also be used to train a good TTS model! (few shot voice ... |
| [rverst/stargazer](https://github.com/rverst/stargazer) | Stargazer creates a sorted list of your stared GitHub repositories - your per... |
| [ryanhanwu/How-To-Ask-Questions-The-Smart-Way](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way) | 本文原文由知名 Hacker Eric S. Raymond 所撰寫，教你如何正確的提出技術問題並獲得你滿意的答案。 |
| [ryanoasis/nerd-fonts](https://github.com/ryanoasis/nerd-fonts) | Iconic font aggregator, collection, & patcher. 3,600+ icons, 50+ patched font... |
| [rzashakeri/beautify-github-profile](https://github.com/rzashakeri/beautify-github-profile) | This repository will assist you in creating a more beautiful and appealing gi... |
...
| [TG-Twilight/Starstruck](https://github.com/TG-Twilight/Starstruck) | Starstruck是一个能让你快速统计某个 GitHub 仓库被哪些“显赫人物” Star 过的工具，顺便也能看看大佬们各自的“影响力”。/ Stars... |
...
| [TheAssassin/AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) | Helper application for Linux distributions serving as a kind of "entry point"... |
| [theme-next/hexo-theme-next](https://github.com/theme-next/hexo-theme-next) | Elegant and powerful theme for Hexo. |
| [themepark-dev/theme.park](https://github.com/themepark-dev/theme.park) | A collection of themes/skins for 50 selfhosted apps! |
| [TheNiteCoder/mountaineer.vim](https://github.com/TheNiteCoder/mountaineer.vim) | A dark and adventurous Vim/Neovim colorscheme I AM NOT THE OWNER(The owner ha... |
...
| [TISUnion/Carpet-TIS-Addition](https://github.com/TISUnion/Carpet-TIS-Addition) | A Carpet mod (fabric-carpet) extension, a collection of carpet mod style usef... |
| [TISUnion/ChatBridge](https://github.com/TISUnion/ChatBridge) | boardcast chat between mc servers or even discord server |
| [TISUnion/daycount](https://github.com/TISUnion/daycount) | None |
...
| [twt-tec/werewolf-master](https://github.com/twt-tec/werewolf-master) | None |
...
| [zhaose233/HMCL-Clean](https://github.com/zhaose233/HMCL-Clean) | Clean Version of HMCL, remove dev/nightly warnings, multiplayer(not FOSS), sp... |
...
| [zhiyiYo/PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) | A fluent design widgets library based on C++ Qt/PyQt/PySide. Make Qt Great Ag... |
| [zhongyang219/TrafficMonitor](https://github.com/zhongyang219/TrafficMonitor) | 这是一个用于显示当前网速、CPU及内存利用率的桌面悬浮窗软件，并支持任务栏显示，支持更换皮肤。 |
| [zhucaidan/mtr_trace](https://github.com/zhucaidan/mtr_trace) | Linux MTR route trace script / 检测VPS回程国内三网路由 |
...
| [ZhuoZhuoCrayon/throttled-py](https://github.com/ZhuoZhuoCrayon/throttled-py) | 🔧 High-performance Python rate limiting library with multiple algorithms (Fix... |
